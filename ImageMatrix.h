...
public:
    ...
    int get_height() const; // Getter function to access height
    int get_width() const; // Getter function to access width
    void setData(double value, int i, int j); // Setter function to set data[i][j] with given value, i and j
